			...
			foreach ($profileFields as $field) {
				...
				<div class="row">
					<div class="large-9 large-centered columns celeste inputers">
						<div class="row">
							<div class="small-3 columns">
								<?php echo $form->labelEx($profile, $field->varname, array('class' => 'right')); ?>
								<?php
								if ($widgetEdit = $field->widgetEdit($profile)) {
									...
									$value = $form->textField($profile, $field->varname);
								}
								?>
							</div>
							<div class="small-9 columns">
								<?php echo $value; ?>
								<small><?php echo $form->error($profile, $field->varname); ?></small>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="large-9 large-centered columns celeste inputers">
				...
				<div class="row">
					<div class="small-12 columns text-right">
						<label for="checkbox1">
							<input type="checkbox" id="checkbox1"> I Accept the terms.
						</label>
					</div>
				</div>
			</div>
