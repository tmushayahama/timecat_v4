	...
	<div id="cabecera" class="bluerer">
		...
		<div id="titler" class="left">
			<p class="eliseo"><strong><?php echo $this->study_name ?></strong><br/>
				<span class="utitler"><?php //echo Yii::app()->email?> - <em><?php //echo $this->role ?></em></span></p>
		</div>
		<div id="quiter" class="right">
			<?php echo CHtml::link('<span class="hide-for-small">Close Study</span><i class="foundicon-right-arrow alinm"></i>', Yii::app()->getModule('user')->returnUrl, array('class' => 'button alert small alcc')); ?>
		</div>		
	</div>
	<div id="main">
		<?php echo $content; ?>
